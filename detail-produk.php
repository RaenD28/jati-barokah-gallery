...
<body>
    ...
    <section class="detail-produk">
        <div class="container-detail">
            ...
            <div class="deskripsi-produk">
                <h2> Satu set Furniture Ruang Tamu </h2>
                <li>Bahan baku:</li>
                <li>Ukuran:</li>
                <li>Model:</li>
                <li>Finishing:</li>
                <li>Warna:</li>
                <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae voluptatem praesentium nam,
                    exercitationem, consequuntur quos autem ipsam corrupti saepe omnis possimus nihil a in ratione.
                    et doloremque.</p>
                <button type="submit" class="button-wa"> Konsultasi via Whatsapp <img src="icon/whatsapp.png"
                        alt="icon-whatsapp">
                </button>
            </div>
        </div>
    ...
    <section class="rekomen-produk">
        <h2 class="judul-rekomen">
            Produk lainnya
        </h2>
